...
const toLastNames = people => {
  // Solution code here...
  let newarr = people.map(names => `${names.firstName} ${names.lastName}`);
  return newarr;
...
const addValues = (arr) => {
  // Solution code here...
  let finalvalue = arr.reduce((accum, Oarray)=>{
    return accum + Oarray;
  }, 0);
  return finalvalue;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let finalvalue = arr.reduce((accum, Oarray)=>{
    return accum + Oarray.purchasePrice;
  }, 0);
  return finalvalue;
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let numberOfElements = arr.reduce((a)=>{
    return a + 1;
